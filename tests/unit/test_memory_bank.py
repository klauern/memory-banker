...
class TestMemoryBank:
    ...
    async def test_update_files(self, memory_bank, sample_agent_responses):
        ...
        content = (memory_bank.memory_bank_path / "projectbrief.md").read_text(encoding='utf-8')
    ...
    async def test_create_files_unicode_content(self, memory_bank):
        ...
        brief_content = (memory_bank.memory_bank_path / "projectbrief.md").read_text(encoding='utf-8')
        assert "🚀" in brief_content
        assert "émojis" in brief_content
        assert "αβγ" in brief_content
        
        tech_content = (memory_bank.memory_bank_path / "techContext.md").read_text(encoding='utf-8')
